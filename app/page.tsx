  ...
  <div className="max-w-7xl mx-auto">
    <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
      <div className="space-y-2">
        ...
        <h2 className="text-3xl md:text-4xl font-serif font-bold text-primary">Featured Categories</h2>
        <div className="flex items-center gap-2">
    ...
    {filteredCategories.length === 0 ? (
      <div className="text-center py-16 bg-gray-50/50 rounded-3xl border border-dashed border-gray-200">
        ...
        <h3 className="text-xl font-serif font-bold text-gray-400 mb-2">
          {selectedBranch !== 'all' ? 'No Categories in this Branch' : 'No Categories Available'}
        </h3>
      </div>
    ) : (
      <Carousel 
          ...
          {filteredCategories.map((category) => (
            <CarouselItem key={category.id} className="pl-4 md:basis-1/2 lg:basis-1/4">
              <Link 
                ...
                className="block"
              >
                <div className="group relative cursor-pointer overflow-hidden rounded-2xl shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="relative aspect-[4/3] w-full overflow-hidden bg-gray-100">
                    <img 
                      ...
                      onError={(e) => {
                        (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1563729784474-d77dbb933a9e?q=80&w=2070&auto=format&fit=crop';
                      }}
                    />
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <h4 className="text-white text-xl font-serif font-bold text-center px-4">
                        {category.name}
                      </h4>
                    </div>
                    ...
                    <div className="absolute top-4 right-4">
                      <Badge className="bg-white/90 backdrop-blur-sm text-primary border-none px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider shadow-md">
                        {category.type}
                      </Badge>
                    </div>
                  </div>
