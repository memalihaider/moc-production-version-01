...
export default function SuperAdminBranches() {
  ...
  const [formData, setFormData] = useState({
    ...
    weeklyTimings: {
      ...
      saturday: { opening: '09:00', closing: '18:00', closed: false },
      sunday: { opening: '09:00', closing: '18:00', closed: true },
    },
  ...
  // 🔥 Aaj ke din ki timing nikalne ka function
  const getTodayTiming = (branch: Branch) => {
    const days = ['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday'];
    const today = new Date().getDay();
    const todayKey = days[today] as keyof typeof branch.weeklyTimings;
    
    if (branch.weeklyTimings?.[todayKey]?.closed) {
      return 'Closed Today';
    }
  ...
  const openEditDialog = (branch: Branch) => {
    ...
    setFormData({
      ...
      weeklyTimings: branch.weeklyTimings || {
        monday: { opening: '09:00', closing: '18:00', closed: false },
        tuesday: { opening: '09:00', closing: '18:00', closed: false },
        wednesday: { opening: '09:00', closing: '18:00', closed: false },
        thursday: { opening: '09:00', closing: '18:00', closed: false },
  ...
  // 🔥 Weekly timings set karne ka function
  const setWeeklyTiming = (day: keyof typeof formData.weeklyTimings, field: 'opening' | 'closing', value: string) => {
    setFormData(prev => ({
      ...prev,
      weeklyTimings: {
        ...prev.weeklyTimings,
        [day]: {
          ...prev.weeklyTimings[day],
          [field]: value
        }
      }
    }));
  ...
  const toggleDayClosed = (day: keyof typeof formData.weeklyTimings) => {
    setFormData(prev => ({
      ...prev,
      weeklyTimings: {
        ...prev.weeklyTimings,
        [day]: {
          ...prev.weeklyTimings[day],
          closed: !prev.weeklyTimings[day].closed
        }
      }
    }));
  };
  ...
  const applyToAllDays = () => {
    const { openingTime, closingTime } = formData;
    const updatedTimings = { ...formData.weeklyTimings };
    
    Object.keys(updatedTimings).forEach(day => {
      updatedTimings[day as keyof typeof updatedTimings] = {
        ...updatedTimings[day as keyof typeof updatedTimings],
        opening: openingTime,
        closing: closingTime
      };
        ...
        <div className="flex-1 overflow-auto">
          <div className="p-4 lg:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium">Weekly Schedules</CardTitle>
                  <Calendar className="h-4 w-4 text-muted-foreground" />
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold">
                    {branches.filter(b => b.weeklyTimings).length}
                  </div>
                  <p className="text-xs text-muted-foreground">
                    With custom timings
                  </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={day} className="space-y-2 p-3 bg-gray-50 rounded-lg">
                            ...
                            <div>
                              ...
                              <Input
                                ...
                                onChange={(e) => setWeeklyTiming(
                                  day as keyof typeof formData.weeklyTimings,
                                  'opening',
                                  e.target.value
                                )}
